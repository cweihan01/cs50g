...
function PlayState:enter(params)
    ...
    -- ensure that player does not spawn on a chasm column
    local i = 1
    while self.tileMap.tiles[self.tileMap.height][i].id == TILE_ID_EMPTY do
        i = i + 1
        self.player.x = (i - 1) * TILE_SIZE
    end
...
function PlayState:update(dt)
    ...
    -- DEBUG: press 'r' to restart board
