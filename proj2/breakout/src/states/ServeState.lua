...
function ServeState:enter(params)
    ...
    -- when user loses a life, reset most powerups but keep some (eg. keys)
    self.powerupEffects = Powerup.resetPowerupEffects(params.powerupEffects)

    -- init new ball (random color for fun except the altBall skin (7))
    self.ball = Ball()
