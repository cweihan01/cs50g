...
--[[
    Piece out a single locked brick in spritesheet.
]]
function GenerateQuadsLockedBrick(atlas)
    return table.slice(GenerateQuads(atlas, 32, 16), 24, 24)[1]
end
...
--[[
    This function generates powerup quads located at the bottom of spritesheet.
]]
