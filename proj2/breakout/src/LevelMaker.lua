...
function LevelMaker.createMap(level)
    ...
    -- highest color of each level, every 5 levels will go through one set of 5 colors
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            -- add random locked bricks, 1/7 chance
            if math.random(7) == 1 then
                b.locked = true
                table.insert(bricks, b)

                -- prevent normal bricks from being generated underneath locked brick
                -- but idk if this will mess up the alternatePattern
                goto continue
            end
